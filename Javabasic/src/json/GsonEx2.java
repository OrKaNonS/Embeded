...
public class GsonEx2 {
	...
	public static void main(String[] args) {
		...
		// 실습4 : 실습3의 Json 문자열을 Map 객체로 변환 후 출력
		Map<String, Integer> map2 = gson.fromJson(mapStr, Map.class);
		System.out.println(map2);
		
		// 실습5 : List객체를 Json 문자열로 변환 후 출력
